...
static const char *const characters = "IT_IS__TUESDAY_THURSDAY_SUNDAY__FRIDAY_SATURDAY___WEDNESDAY__MONDAY__THETWENTYTWENTIETHTHIRTIETHTHIRTY_NINETEENTHSECOND_FOURTH_ELEVENTHFIFTEENTH__EIGHTEENTH_FOURTEENTH_SIXTEENTHTHIRTEENTHSIXTHFIRST_THIRD_SEVENTEENTH_TENTHFIFTHTWELFTHSEVENTH_EIGHTHNINTH_OF_NOVEMBERJANUARYMAY_FEBRUARYAPRILAUGUST_OCTOBER_SEPTEMBER__DECEMBERJULY_MARCHJUNETHE_TIME_IS__QUARTERHALF__TWENTY_TENSIXTEENTWONESEVENTEEN_FIVENINETEEN__TWELVE_FOURTEEN_EIGHTEENELEVENTHIRTEENTHREE_PASTTO_THREE_SEVENTWO_ELEVENFOUR_ONENINESIXTEN_FIVE___TWELVE__EIGHT__O'CLOCKAT_NIGHT_IN_THE_MORNING__EVENING_AFTERNOON_DEBUG";
